...
public class DomresStationFleetManager extends SourceBasedFleetManager {
	...
	protected CampaignFleetAPI spawnFleet() {
		...
		DomresSeededFleetManager.initDomresFleetProperties(random, fleet, false);
		
		fleet.setLocation(source.getLocation().x, source.getLocation().y);
		fleet.setFacing(random.nextFloat() * 360f);
		
		fleet.addScript(new DomresAssignmentAI(fleet, (StarSystemAPI) source.getContainingLocation(), source));
