...
public class HMI_tabitha {
    ...
    public static float radius_variation = 800f;
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(star, 50, 2500, 300, 200, 300, Terrain.ASTEROID_BELT, null);
		...
		system.addRingBand(star, "misc", "rings_dust0", 256f, 2, Color.cyan, 256f, 2400, 130f);
		system.addRingBand(star, "misc", "rings_dust0", 256f, 1, Color.white, 256f, 2600, 80f);
		system.addRingBand(star, "misc", "rings_dust0", 256f, 0, Color.white, 256f, 2700, 100f);

		system.addRingBand(star, "misc", "rings_dust0", 256f, 0, Color.blue, 256f, 3200, 80f);
		system.addRingBand(star, "misc", "rings_dust0", 256f, 1, Color.white, 256f, 3400, 130f);
		system.addRingBand(star, "misc", "rings_dust0", 256f, 1, Color.white, 256f, 3500, 140f);

		system.addRingBand(star, "misc", "rings_dust0", 256f, 2, Color.white, 256f, 4450, 130f);
		system.addRingBand(star, "misc", "rings_dust0", 256f, 1, Color.blue, 256f, 4500, 80f);

		system.addRingBand(star, "misc", "rings_ice0", 256f, 0, Color.white, 256f, 6500, 100f);
		system.addRingBand(star, "misc", "rings_ice0", 256f, 2, Color.blue, 256f, 6600, 140f);
		...
		system.addRingBand(star, "misc", "rings_ice0", 256f, 2, Color.blue, 256f, 8400, 180f);

		SectorEntityToken ring1 = system.addTerrain(Terrain.RING, new RingParams(600+256, 2500, null, "Resin's Dress"));
		ring1.setCircularOrbit(star, 0, 0, 100);
		SectorEntityToken ring1a = system.addTerrain(Terrain.RING, new RingParams(600+256, 3200, null, "Resin's Dress"));
		ring1.setCircularOrbit(star, 0, 0, 100);
		SectorEntityToken ring2 = system.addTerrain(Terrain.RING, new RingParams(600+256, 4100, null, "Resin's Dress"));
		ring2.setCircularOrbit(star, 0, 0, 100);
		SectorEntityToken ring3 = system.addTerrain(Terrain.RING, new RingParams(600+256, 5100, null, "Resin's Dress"));
		ring3.setCircularOrbit(star, 0, 0, 100);
		SectorEntityToken ring4 = system.addTerrain(Terrain.RING, new RingParams(600+256, 6650, null, "Resin's Dress"));
		ring4.setCircularOrbit(star, 0, 0, 100);
		SectorEntityToken ring5 = system.addTerrain(Terrain.RING, new RingParams(600+256, 8300, null, "Resin's Dress"));
		...
		DomresStationFleetManager DomresFleets = new DomresStationFleetManager(
				PristineDerelictStation, 1.0f, 1, maxFleets, 10.0f, 10, 80);
		...
		PlanetAPI tabitha2b = system.addPlanet("hmi_spirit2", tabitha2, "Gasoline", "cryovolcanic", 0, 100, 2850, 200);
		...
		PlanetAPI tabitha2c = system.addPlanet("hmi_spirit3", tabitha2, "Petroleum", "toxic_cold", 200, 100, 3450, 300);
...
///		ALICIA, SYSTEM2
		...
		SectorEntityToken PresterEventHorizonOuter2 = system2.addTerrain(Terrain.EVENT_HORIZON,
				new EventHorizonPlugin.CoronaParams(800,
						400,
						star2,
						-8f,
						0f,
		...
		for (float i = 0; i < numBands; i++) {
			...
			RingBandAPI visual = system2.addRingBand(star2, "misc", ringhole, 256f, 0, Color.white, bandWidth,
		...
		SectorEntityToken ringhole = system2.addTerrain(Terrain.RING, new BaseRingTerrain.RingParams(orbitRadius, orbitRadius / 2f, star2, "Accretion Disk"));
		...
		//JUMP POINT
		JumpPointAPI jumpPointAlicia = Global.getFactory().createJumpPoint("alicia_jumpPointA", "Alicia Jump-Point");
