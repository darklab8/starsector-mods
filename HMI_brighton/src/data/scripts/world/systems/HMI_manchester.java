...
///    }
    ...
    public static String DOMRES_HABITAT_KEY = "$hmi_domres_habitat_key";
    public static String DOMRES_MINING_KEY = "$hmi_domres_mining_key";
    public static String DOMRES_SCIENCE_KEY = "$hmi_domres_science_key";
    public static String DOMRES_SURPRISE1_KEY = "$hmi_domres_surprise1_key";
    public static String DOMRES_SURPRISE2_KEY = "$hmi_domres_surprise2_key";
    public static String DOMRES_SURPRISE3_KEY = "$hmi_domres_surprise3_key";
    public static String DOMRES_SURPRISE4_KEY = "$hmi_domres_surprise4_key";
    ...
    public void generate(SectorAPI sector) {
        ...
        innerguardDerelict3.getMemoryWithoutUpdate().set(DOMRES_SURPRISE4_KEY, true);
        innerguardDerelict3.setCircularOrbit(star, 0, 2250, 36f);
        Misc.setDefenderOverride(innerguardDerelict3, new DefenderDataOverride("domres", 1f, 20, 20, 1));
        ...
        stationDerelict1.getMemoryWithoutUpdate().set(DOMRES_HABITAT_KEY, true);
        ...
        manchester4.getMarket().addCondition(Conditions.HABITABLE);
        manchester4.getMarket().addCondition(Conditions.COLD);
        ...
        manchester4.getMarket().addCondition(Conditions.FARMLAND_POOR);
        ...
        innerguardDerelict3.getMemoryWithoutUpdate().set(DOMRES_SCIENCE_KEY, true);
        ...
        addDerelict(system, devon_mirror_relay, "tarsus_Standard", ShipRecoverySpecial.ShipCondition.BATTERED, 270f,  (Math.random()<0.6));
        ...
        innerguardDerelictLoc.getMemoryWithoutUpdate().set(DOMRES_SURPRISE1_KEY, true);
        innerguardDerelictLoc.setCircularOrbit(star, 60f, 9000, 160f);
        Misc.setDefenderOverride(innerguardDerelictLoc, new DefenderDataOverride("domres", 1f, 150, 300));
        ...
        stationDerelict3.getMemoryWithoutUpdate().set(DOMRES_MINING_KEY, true);
        ...
        innerguardDerelict5L4.getMemoryWithoutUpdate().set(DOMRES_SURPRISE2_KEY, true);
        innerguardDerelict5L4.setCircularOrbit(star, 290, 13500, 450);
        Misc.setDefenderOverride(innerguardDerelict5L4, new DefenderDataOverride("domres", 1f, 50, 100));
        ...
        guardDerelict1.getMemoryWithoutUpdate().set(DOMRES_SURPRISE3_KEY, true);
        guardDerelict1.setCircularOrbit(jumpPoint, 0, 400, 180f);
        Misc.setDefenderOverride(guardDerelict1, new DefenderDataOverride("domres", 1f, 50, 100));
        ...
        //JUMP POINT
        JumpPointAPI jumpPointYork = Global.getFactory().createJumpPoint("york_jumpPointA", "York Jump-Point");
        ...
        PlanetAPI essex1 = system3.addPlanet("essex1", star3, "Scarborough's Landing", "barren", 120, 150, 3000, 360);
        Misc.initConditionMarket(manchester5b);
        essex1.getMarket().addCondition(Conditions.THIN_ATMOSPHERE);
        essex1.getMarket().addCondition(Conditions.RUINS_WIDESPREAD);
        essex1.getMarket().addCondition(Conditions.RARE_ORE_SPARSE);
        essex1.setCustomDescriptionId("domres_landing");

        addDerelict(system3, essex1, "wayfarer_Standard", ShipRecoverySpecial.ShipCondition.BATTERED, 500f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "kite_pirates_Raider", ShipRecoverySpecial.ShipCondition.WRECKED, 340f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "hound_d_pirates_Standard", ShipRecoverySpecial.ShipCondition.BATTERED, 330f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "cerberus_d_pirates_Standard", ShipRecoverySpecial.ShipCondition.BATTERED, 2500f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "colossus3_Pirate", ShipRecoverySpecial.ShipCondition.WRECKED, 320f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "cerberus_d_pirates_Standard", ShipRecoverySpecial.ShipCondition.WRECKED, 270f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "phaeton_Standard", ShipRecoverySpecial.ShipCondition.BATTERED, 300f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "eradicator_pirates_Attack", ShipRecoverySpecial.ShipCondition.WRECKED, 260f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "enforcer_d_pirates_Strike", ShipRecoverySpecial.ShipCondition.BATTERED, 250f,  (Math.random()<0.6));
        addDerelict(system3, essex1, "tarsus_Standard", ShipRecoverySpecial.ShipCondition.WRECKED, 320f,  (Math.random()<0.6));
        ...
        //JUMP POINT
        JumpPointAPI jumpPointEssex = Global.getFactory().createJumpPoint("essex_jumpPointA", "Essex Jump-Point");
...
///        StarSystemAPI system4 = sector.createStarSystem("Exeter");
        ...
        //JUMP POINT
        JumpPointAPI jumpPointExeter = Global.getFactory().createJumpPoint("exeter_jumpPointA", "Exeter Jump-Point");
