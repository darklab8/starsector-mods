...
public class LTA_TalonRailAutomatedNixie extends BaseEveryFrameCombatPlugin {
    
    private CombatEngineAPI engine;
    
    private final IntervalUtil DARKSUMMONINGRITUALFROMBEYONDTHEGREYSUN3 = new IntervalUtil(0.1f, 0.1f);   
    
    private final IntervalUtil interval = new IntervalUtil(0.1f, 0.1f);
    private float timer = 0f;       //Timer
    private float duration = 0.05f; //Duration of the effect
    
    private static final String LTA_TalonAutomatedNixieShipID = "LTA_TalonNixie_Railfed_Interceptor_Wing";
    private static final String LTA_TalonAutomatedNixieProjectileID = "LTA_talonnixie_lrm";
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        while (iter.hasNext()) {
            ...
            if (DARKSUMMONINGRITUALFROMBEYONDTHEGREYSUN3.getElapsed() >= 0.1f) {
            switch (projectile.getProjectileSpecId()) {
                case LTA_TalonAutomatedNixieProjectileID: {
                    ...
                    FleetMemberAPI missileMember = Global.getFactory().createFleetMember(FleetMemberType.FIGHTER_WING, LTA_TalonAutomatedNixieShipID);
                    ...
                    missile.setCRAtDeployment(1.0f);
            ...
            DARKSUMMONINGRITUALFROMBEYONDTHEGREYSUN3.advance(amount);
        }
    }
