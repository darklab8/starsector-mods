...
import data.scripts.weapons.HMI_SV_ArcMineScript;
...
public class HMI_SV_MineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	
	protected static float MINE_RANGE = 1800f;
	
	public static final float MIN_SPAWN_DIST = 85f;
	public static final float MIN_SPAWN_DIST_FRIGATE = 120f;
	public static final float MIN_SPAWN_DIST_FIGHTER = 0f;

	public static final float LIVE_TIME = 5f;

	public static final Color JITTER_COLOR = new Color(219, 255, 223, 202);
	public static final Color JITTER_UNDER_COLOR = new Color(27, 255, 19, 176);
	...
	public void spawnMine(ShipAPI source, Vector2f mineLoc) {
		...
		engine.addPlugin(new HMI_SV_ArcMineScript(source, mine));
		if (source != null) {
...
//			float r = other.getCollisionRadius();
			...
			if (other.isFighter()) checkDist = MIN_SPAWN_DIST_FIGHTER;
			if (dist < r + checkDist) {
				return false;
			}
		}
