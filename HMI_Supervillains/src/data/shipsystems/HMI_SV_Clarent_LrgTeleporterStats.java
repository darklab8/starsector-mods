...
public class HMI_SV_Clarent_LrgTeleporterStats extends BaseShipSystemScript {
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		float actualLightningRange = 1200f;
		float actualLightingDamage = 300f;
		float actualLightningEMP = 600f;
		int arcnumber = 32;
