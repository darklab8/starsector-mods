...
public class HMI_SV_DamperFieldStatsHeavy extends BaseShipSystemScript {
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		stats.getHullDamageTakenMult().modifyMult(id, 0.33f * effectLevel);
		...
		if (player) {
			...
			if (system != null) {
				float percent = 0.66f * effectLevel * 100;
