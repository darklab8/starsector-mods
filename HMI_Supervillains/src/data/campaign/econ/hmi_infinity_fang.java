...
public class hmi_infinity_fang extends BaseMarketConditionPlugin {
...
//        }
    ...
    public static boolean NoFang(MarketAPI market) {
        ...
        for (MarketAPI othermarket : Global.getSector().getEconomy().getMarkets(thissystem)) {
            if (othermarket.getFactionId().equals("fang")) hasFang = true;
        }
        return hasFang;
    }
}
