...
public class hmi_draco_spawn extends BaseMarketConditionPlugin {

	private static String [] dracoFactions = new String [] {
		"draco",
	};
	public static float DEFENSE_BONUS = 1000;

	public void apply(String id) {
		if (Arrays.asList(dracoFactions).contains(market.getFactionId())) {
			market.getStability().modifyFlat(id, ConditionData.STABILITY_LUDDIC_MAJORITY_BONUS, "Draco Support");
		} else {
			market.getStability().modifyFlat(id, ConditionData.STABILITY_LUDDIC_MAJORITY_PENALTY, "Draco Group Subversion");
		}
